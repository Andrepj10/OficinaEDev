...
from apps.agenda.views import novo_evento, novos_eventos, editar_evento, deletar_evento, filtro, evento_andamento, evento_concluido, concluir_evento
...
urlpatterns = [
    ...
    path('novos-eventos', novos_eventos, name='novos_eventos'),
